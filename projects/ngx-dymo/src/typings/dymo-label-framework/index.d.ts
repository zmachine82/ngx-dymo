...
declare namespace dymo.label.framework {
	...
	function getPrintersAsync(): Promise<PrinterInfo[]>;

	function init(any: any): any;
	...
	function printLabelAsync(printerName: string, printParamsXml: string, labelXml:string, labelSetXml: string): void;
	/**
	...
	function renderLabelAsync(labelXml: string, renderParamsXml: string, printerName: string): Promise<string>;
